...
- [template-skill](https://skills.sh/anthropics/skills/template-skill) — This skill provides a baseline template for creating new skills with reusable sections and conventions.
...
- ⭐ [create-plan](https://skills.sh/openai/skills/create-plan) — This skill creates structured implementation plans with milestones, risks, and completion criteria.

  `npx skills add https://github.com/openai/skills --skill create-plan`
- ⭐ [codex-readiness-unit-test](https://skills.sh/openai/skills/codex-readiness-unit-test) — This skill improves project readiness for unit-test-driven development and execution quality checks.

  `npx skills add https://github.com/openai/skills --skill codex-readiness-unit-test`
- ⭐ [codex-readiness-integration-test](https://skills.sh/openai/skills/codex-readiness-integration-test) — This skill improves integration-test readiness with environment, dependency, and validation guidance.

  `npx skills add https://github.com/openai/skills --skill codex-readiness-integration-test`
- [build-things](https://skills.sh/openai/skills/build-things) — This skill supports rapid prototyping and iterative implementation from idea to working output.

  `npx skills add https://github.com/openai/skills --skill build-things`
- [gitlab-address-comments](https://skills.sh/openai/skills/gitlab-address-comments) — This skill helps triage and resolve merge-request comments in GitLab workflows.

  `npx skills add https://github.com/openai/skills --skill gitlab-address-comments`
- [codex-wrapped](https://skills.sh/openai/skills/codex-wrapped) — This skill provides a wrapped workflow for Codex-based implementation and task execution.

  `npx skills add https://github.com/openai/skills --skill codex-wrapped`
- [atlas](https://skills.sh/openai/skills/atlas) — This skill supports Atlas-centric workflows for structured navigation and execution across project context.

  `npx skills add https://github.com/openai/skills --skill atlas`
...
- **6x azure-*** ([6x azure-* collection](https://github.com/github/awesome-copilot/tree/main/skills)) — Collection of Azure-focused skills for diagnostics, cost optimization, observability, RBAC, and infrastructure workflows.
...
- **⭐ dotnet-best-practices Ensure** ([dotnet-best-practices-ensure.SKILL.md](https://github.com/github/awesome-copilot/blob/main/skills/dotnet-best-practices-ensure/SKILL.md)) — .NET/C# code meets best practices for the solution/project.
